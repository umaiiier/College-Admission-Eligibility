...
if (intermediate_Percentage >= 50 && matric_Percentage >= 50)
    cout << "Congratulations! " << name << " , You are eligible for admission." << endl;

else
    cout << "Sorry, " << name << " , You are not eligible for admission." << endl;
